...
### FetchXML Builder
- Permet de requêter les données selon un format (Utile pour Power Automate ou le dev côté serveur)
<img src="../../files/Xrm_FetchXmlBuilder.png" alt="Xrm_FetchXmlBuilder" style="width:30%"/>
<br><br>
